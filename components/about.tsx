  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        capabilities, is my canvas; I craft intricate, interactive features with
        this versatile language.{" "}
        <span className="font-medium italic">
          React JS, Next.js, Bootstrap, Material UI, and Tailwind CSS
        </span>{" "}
        are my trusty brushes, helping me shape captivating user interfaces and
        responsive designs. My familiarity with databases like{" "}
        ...
        just functional but also aesthetically pleasing. Crafting clean and
        modern websites using{" "}
        <span className="font-medium italic">
          Next.js, Tailwind CSS, Node Mailer, and Framer Motion
        </span>{" "}
        has been a particularly rewarding experience. It's about creating
        digital spaces that users can effortlessly navigate, irrespective of the
        device they're on.
        <br />
        My passion extends to e-commerce as well, where I've worked extensively
        with <span className="font-medium">WordPress and WooCommerce</span>,
        ...
        React JS and Bootstrap, where users can create, edit, filter, and delete
        notes. It's the fusion of creativity and functionality that excites me
        every day.
        <br />
        ...
        technology. Staying updated and continually learning is not just a habit
        but a way of life for me. I'm eager to explore new challenges and bring
        my skills to the table, whether it's designing a sleek website, crafting
        efficient code, or contributing innovative ideas to a team.
        <br />
        Thank you for taking the time to get to know me. I'm excited about the
        prospect of collaborating on projects that push the boundaries of what's
        possible in the digital world. If you'd like to connect, discuss ideas,
